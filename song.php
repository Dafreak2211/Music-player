  ...
  <body>
            ...
            "<?php 
              if($pageno <= 1){ echo '#'; } 
                ...
                if(isset($_GET['playlist'])){
                  echo "?pageno=" .($pageno - 1) . "&playlist=$_GET[playlist]";
                }else{
    ...
    <div class="music-container" id="music-container">
      ...
      <div class="img-container">
        <img alt="music-cover" src="./images/hey.jpg" id="cover"/>
      </div>
    ...
    <?php 
      if(isset($_GET['playlist'])){
        echo "<a href='index.php' class='favoriteBtn'>Go home</a>";
      }else{
        echo "<a href='?playlist=1' class='favoriteBtn'>Favorite Playlist</a>";
      }
